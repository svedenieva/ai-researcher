...
export function mindsheetStrings(lang: Lang): MindSheetStrings {
  const T: Record<Lang, MindSheetStrings> = {
    uk: {
      ...
      widthHead: 'Ширина', fitContent: 'За вмістом', fitAllContent: 'Підігнати всі за вмістом', shrinkAllContent: 'Звузити всі колонки', resetWidth: 'Скинути ширину', deleteColumn: 'Видалити колонку',
      ...
      addColNamePlaceholder: 'Назва', addColumnAria: 'Додати колонку', nothingFound: 'Нічого не знайдено',
    ...
    ru: {
      ...
      widthHead: 'Ширина', fitContent: 'По содержимому', fitAllContent: 'Подогнать все под содержимое', shrinkAllContent: 'Сузить все колонки', resetWidth: 'Сбросить ширину', deleteColumn: 'Удалить колонку',
      ...
      addColNamePlaceholder: 'Название', addColumnAria: 'Добавить колонку', nothingFound: 'Ничего не найдено',
    ...
    en: {
      ...
      widthHead: 'Width', fitContent: 'Fit to content', fitAllContent: 'Fit all to content', shrinkAllContent: 'Shrink all columns', resetWidth: 'Reset width', deleteColumn: 'Delete column',
      ...
      addColNamePlaceholder: 'Name', addColumnAria: 'Add column', nothingFound: 'Nothing found',
