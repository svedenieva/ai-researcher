...
export function mindsheetStrings(lang: Lang): MindSheetStrings {
  const T: Record<Lang, MindSheetStrings> = {
    uk: {
      ...
      widthHead: 'Ширина', fitContent: 'За вмістом', fitAllContent: 'Підігнати всі за вмістом', resetWidth: 'Скинути ширину', deleteColumn: 'Видалити колонку',
    ...
    ru: {
      ...
      widthHead: 'Ширина', fitContent: 'По содержимому', fitAllContent: 'Подогнать все под содержимое', resetWidth: 'Сбросить ширину', deleteColumn: 'Удалить колонку',
    ...
    en: {
      ...
      widthHead: 'Width', fitContent: 'Fit to content', fitAllContent: 'Fit all to content', resetWidth: 'Reset width', deleteColumn: 'Delete column',
