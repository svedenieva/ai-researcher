...
export function mindsheetStrings(lang: Lang): MindSheetStrings {
  const T: Record<Lang, MindSheetStrings> = {
    uk: {
      ...
      widthHead: 'Ширина', fitContent: 'За вмістом', resetWidth: 'Скинути ширину', deleteColumn: 'Видалити колонку',
    ...
    ru: {
      ...
      widthHead: 'Ширина', fitContent: 'По содержимому', resetWidth: 'Сбросить ширину', deleteColumn: 'Удалить колонку',
    ...
    en: {
      ...
      widthHead: 'Width', fitContent: 'Fit to content', resetWidth: 'Reset width', deleteColumn: 'Delete column',
