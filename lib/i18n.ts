...
export function mindsheetStrings(lang: Lang): MindSheetStrings {
  const T: Record<Lang, MindSheetStrings> = {
    uk: {
      ...
      addColNamePlaceholder: 'Назва', addColumnAria: 'Додати колонку', nothingFound: 'Нічого не знайдено', emptyTitle: 'Тут поки порожньо', emptyHint: 'Додайте перший рядок',
    ...
    ru: {
      ...
      addColNamePlaceholder: 'Название', addColumnAria: 'Добавить колонку', nothingFound: 'Ничего не найдено', emptyTitle: 'Здесь пока пусто', emptyHint: 'Добавьте первую строку',
    ...
    en: {
      ...
      addColNamePlaceholder: 'Name', addColumnAria: 'Add column', nothingFound: 'Nothing found', emptyTitle: 'Nothing here yet', emptyHint: 'Add the first row',
